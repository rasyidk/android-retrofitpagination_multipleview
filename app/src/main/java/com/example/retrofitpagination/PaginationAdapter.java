...
public class PaginationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<Halaman> halamanList;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == 0) {
            ...
            return new HeroVH(view);
        }

        view = layoutInflater.inflate(R.layout.item_list2, parent, false);
...
//                break;
//            case HERO:
//                View viewHero = inflater.inflate(R.layout.item_list2, parent, false);
...
//        return viewHolder;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (TextUtils.isEmpty(movieResults.get(position).getPosterpath())){
            final MovieVH movieVH = (MovieVH) holder;
            movieVH.mMovieTitle.setText(result.getId());

        }else {

            final HeroVH heroVh = (HeroVH) holder;
            heroVh.mMovieTitle.setText(result.getId());
//                String url = "https://image.tmdb.org/t/p/w200/"+ result.getPosterpath() +"";
//                Log.d("BRO", url);
//
//                Glide.with(context)
//                        .asBitmap()
//                        .load("https://image.tmdb.org/t/p/w200/"+ result.getPosterpath() +"")
...
//        } else {
       ...
       // }
//        if (movieResults.get(position).getPosterpath().equals("kosong")) {
//            return (position == movieResults.size() - 1) ? LOADING : HERO;
//        }
//     return (position == movieResults.size() - 1) ? LOADING : ITEM;
...
//            if (movieResults.get(position).getPosterpath().toLowerCase().contains("kosong")) {
//
//            }else {
//                data = 1;
//            }
    ...
    */
    ...
    protected class MovieVH extends RecyclerView.ViewHolder {
        ...
        public MovieVH(View itemView) {
            ...
            mMovieTitle = itemView.findViewById(R.id.movie_title2);
